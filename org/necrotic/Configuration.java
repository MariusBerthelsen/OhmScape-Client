...
public class Configuration {
	...
	/** MAIN CONSTANTS **/
	public final static String CLIENT_NAME = "OhmScape";
	public final static int CLIENT_VERSION = 55;
	public final static String CACHE_DIRECTORY_NAME = "OhmCache"; //Cache folder name
	public static final String SETTINGS_DIRECTORY_NAME = "OhmSettings";
